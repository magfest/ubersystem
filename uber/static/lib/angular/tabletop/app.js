angular.module('tabletop', ['ngRoute', 'magfest', 'ui.bootstrap'])
    .config(function($routeProvider){
        $routeProvider
            .when('/', {controller: 'GameListController', templateUrl: '../static/lib/angular/tabletop/game_list.html'})
            .when('/form', {controller: 'GameFormController', templateUrl: '../static/lib/angular/tabletop/form.html'})
