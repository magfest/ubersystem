...
def get_graphs_data():
    ...
    m12_date = date(2014, 1, 5)  # date magfest ENDS
    ...
    return {
        ...
        "m11_by_now": m11[(date(2013, 1, 3) - timedelta(days=until)).strftime("%Y-%m-%d")],
        ...
        "m10_lookup": m10,
        "m11_coords": sorted(m11.items()),
        "m11_lookup": m11,
        "m12_coords": sorted(curr.items()),
        "m12_lookup": curr,
        ...
        #"m11_regs": m11_regs.get((date(2013, 1, 3) - timedelta(days=until)).strftime("%Y-%m-%d"), [0,0]),
        #"m12_regs": m12_regs
    }
