...
def _release_badge_lock_on_error(*args, **kwargs):
    try:
        ...
        log.warn('failed releading BADGE_LOCK on db error; these errors should not happen in the first place and we do not expect releasing the lock to fail when they do, but we still want to keep going if/when this does occur')
