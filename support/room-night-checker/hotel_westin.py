...
class WestinHotelRoomChecker(HotelRoomChecker):
    def check_nights(self, night_dates, browser):
        ...
        return ["Westin", availability]

    def check_night(self, night_date, browser):
        print "Westin|" + night_date.strftime("%m/%d/%y")

        browser.visit('https://www.starwoodmeeting.com/StarGroupsWeb/res?id=1310219832&key=DE27A')
