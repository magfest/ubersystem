...
attraction_feature_table = table(
    ...
    sa.Column('attraction_id', sa.Uuid(as_uuid=False)),
)
...
attraction_event_table = table(
    ...
    sa.Column('id', sa.Uuid(as_uuid=False)),
    sa.Column('attraction_id', sa.Uuid(as_uuid=False)),
    sa.Column('attraction_feature_id', sa.Uuid(as_uuid=False)),
)
...
attraction_signup_table = table(
    ...
    sa.Column('id', sa.Uuid(as_uuid=False)),
    sa.Column('attraction_id', sa.Uuid(as_uuid=False)),
    sa.Column('attraction_event_id', sa.Uuid(as_uuid=False)),
...
def upgrade():
    if is_sqlite:
        ...
        with op.batch_alter_table('attraction_event', reflect_kwargs=sqlite_reflect_kwargs) as batch_op:
            batch_op.add_column(sa.Column('attraction_id', sa.Uuid(as_uuid=False), nullable=True))
        ...
        op.add_column('attraction_event', sa.Column('attraction_id', sa.Uuid(as_uuid=False), nullable=True))

        op.add_column('attraction_signup', sa.Column('attraction_id', sa.Uuid(as_uuid=False), nullable=True))
    ...
    if is_sqlite:
        ...
        with op.batch_alter_table('attraction_signup', reflect_kwargs=sqlite_reflect_kwargs) as batch_op:
            ...
            batch_op.alter_column('checkin_time', existing_type=sa.DateTime(timezone=True), nullable=False)
            batch_op.alter_column('signup_time', existing_type=sa.DateTime(timezone=True), server_default=None)
        ...
        op.alter_column('attraction_signup', 'checkin_time', existing_type=sa.DateTime(timezone=True), nullable=False)
        op.alter_column('attraction_signup', 'signup_time', existing_type=sa.DateTime(timezone=True), server_default=None)
    ...
    sa.Column('id', sa.Uuid(as_uuid=False), nullable=False),
    sa.Column('attraction_event_id', sa.Uuid(as_uuid=False), nullable=True),
    sa.Column('attraction_id', sa.Uuid(as_uuid=False), nullable=True),
...
def downgrade():
    ...
    op.alter_column('attraction_signup', 'signup_time', existing_type=sa.DateTime(timezone=True), server_default=text(utcnow_server_default))
    op.alter_column('attraction_signup', 'checkin_time', existing_type=sa.DateTime(timezone=True), nullable=True)
