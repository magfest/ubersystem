...
def upgrade():
    ...
    sa.Column('signed_up', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('attendee_id', sa.Uuid(as_uuid=False), nullable=False),
    sa.Column('checked_out', sa.DateTime(timezone=True), nullable=False),
    sa.Column('returned', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('id', sa.Uuid(as_uuid=False), nullable=False),
    sa.Column('entrant_id', sa.Uuid(as_uuid=False), nullable=False),
    ...
    sa.Column('id', sa.Uuid(as_uuid=False), nullable=False),
    sa.Column('entrant_id', sa.Uuid(as_uuid=False), nullable=True),
    sa.Column('sid', sa.Unicode(), server_default='', nullable=False),
    sa.Column('when', sa.DateTime(timezone=True), nullable=False),
    sa.Column('text', sa.Unicode(), server_default='', nullable=False),
