...
def upgrade():
    ...
    op.add_column('receipt_item', sa.Column('cost_snapshot', JSON(), server_default='{}', nullable=False))
    op.add_column('receipt_item', sa.Column('refund_snapshot', JSON(), server_default='{}', nullable=False))
