...
def upgrade():
    op.add_column('art_show_application', sa.Column('checked_in', DateTime(), nullable=True))
    op.add_column('art_show_application', sa.Column('checked_out', DateTime(), nullable=True))
