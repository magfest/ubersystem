...
def upgrade():
    op.add_column('art_show_application', sa.Column('checked_in', sa.DateTime(timezone=True), nullable=True))
    op.add_column('art_show_application', sa.Column('checked_out', sa.DateTime(timezone=True), nullable=True))
