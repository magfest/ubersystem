...
def upgrade():
    ...
    op.add_column('event', sa.Column('location_id', residue.UUID(), nullable=True))
    ...
    op.create_foreign_key(op.f('fk_event_location_id_event_location'), 'event', 'event_location', ['location_id'], ['id'], ondelete='SET NULL')
