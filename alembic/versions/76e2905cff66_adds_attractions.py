...
def upgrade():
    ...
    sa.Column('notifications', JSONB(), server_default='[]', nullable=False),
    ...
    sa.Column('id', UUID(), nullable=False),
    sa.Column('attraction_feature_id', UUID(), nullable=False),
    ...
    sa.Column('signup_time', DateTime(), server_default=sa.text(utcnow_server_default), nullable=False),
    sa.Column('checkin_time', DateTime(), nullable=True),
