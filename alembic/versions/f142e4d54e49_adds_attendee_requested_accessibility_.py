...
def upgrade():
    op.add_column('attendee', sa.Column('requested_accessibility_services', sa.Boolean(), server_default='False', nullable=False))


def downgrade():
    op.drop_column('attendee', 'requested_accessibility_services')
