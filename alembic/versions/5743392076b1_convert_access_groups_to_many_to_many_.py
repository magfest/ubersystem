...
admin_account = table(
    ...
    sa.Column('access_group_id', sa.Uuid(as_uuid=False)),
)
...
admin_access_group = table(
    'admin_access_group',
    sa.Column('admin_account_id', sa.Uuid(as_uuid=False)),
    sa.Column('access_group_id', sa.Uuid(as_uuid=False)),
)
...
def upgrade():
    ...
    sa.Column('access_group_id', sa.Uuid(as_uuid=False), nullable=False),
