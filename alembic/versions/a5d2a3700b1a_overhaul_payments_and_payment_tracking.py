...
def upgrade():
    ...
    with op.batch_alter_table("receipt_item") as batch_op:
        batch_op.drop_constraint('fk_receipt_item_group_id_group', type_='foreignkey')
        batch_op.drop_constraint('fk_receipt_item_txn_id_stripe_transaction', type_='foreignkey')
        batch_op.drop_constraint('fk_receipt_item_attendee_id_attendee', type_='foreignkey')
    ...
    with op.batch_alter_table("attendee") as batch_op:
        batch_op.drop_column('base_badge_price')
        batch_op.add_column(sa.Column('badge_cost', sa.Integer(), nullable=True))
        batch_op.drop_column('payment_method')
        batch_op.drop_column('refunded_items')
        batch_op.drop_column('amount_refunded_override')
        batch_op.drop_column('purchased_items')
        batch_op.drop_column('amount_paid_override')
    ...
    with op.batch_alter_table("marketplace_application") as batch_op:
        batch_op.drop_column('base_price')
        batch_op.drop_column('amount_paid')
...
def downgrade():
    ...
    op.add_column('group', sa.Column('purchased_items', postgresql.JSON(astext_type=sa.Text()), server_default=sa.text("'{}'::JSON"), autoincrement=False, nullable=False))
    ...
    op.add_column('attendee', sa.Column('purchased_items', postgresql.JSON(astext_type=sa.Text()), server_default=sa.text("'{}'::JSON"), autoincrement=False, nullable=False))
    ...
    op.add_column('attendee', sa.Column('refunded_items', postgresql.JSON(astext_type=sa.Text()), server_default=sa.text("'{}'::JSON"), autoincrement=False, nullable=False))
