...
def upgrade():
    ...
    op.add_column('attraction', sa.Column('send_emails', sa.Boolean(), server_default='True', nullable=False))
    ...
    op.add_column('attraction_event', sa.Column('send_emails', sa.Boolean(), server_default='True', nullable=False))
    ...
    op.add_column('attraction_feature', sa.Column('send_emails', sa.Boolean(), server_default='True', nullable=False))
    ...
    op.add_column('attraction_feature', sa.Column('warn_overlap', sa.Boolean(), server_default='True', nullable=False))
...
def downgrade():
    ...
    op.drop_column('attraction_feature', 'warn_overlap')
    ...
    op.drop_column('attraction_feature', 'send_emails')
    ...
    op.drop_column('attraction_event', 'send_emails')
    ...
    op.drop_column('attraction', 'send_emails')
