...
def upgrade():
    ...
    sa.Column('approved', DateTime(), nullable=True),
    ...
    sa.Column('id', UUID(), nullable=False),
    sa.Column('watchlist_id', UUID(), nullable=True),
    ...
    sa.Column('reg_station', sa.Integer(), nullable=True),
    sa.Column('registered', DateTime(), server_default=sa.text(utcnow_server_default), nullable=False),
    sa.Column('checked_in', DateTime(), nullable=True),
    ...
    *[c for c in [sa.UniqueConstraint('badge_num', deferrable='True', initially='DEFERRED', name=op.f('uq_attendee_badge_num'))] if not is_sqlite]
    ...
    sa.Column('id', UUID(), nullable=False),
    sa.Column('picked_up_by_id', UUID(), nullable=False),
    sa.Column('picked_up_for_id', UUID(), nullable=False),
    ...
    sa.Column('generated', DateTime(), server_default=sa.text(utcnow_server_default), nullable=False),
    sa.Column('hashed', sa.Unicode(), server_default='', nullable=False),
