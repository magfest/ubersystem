...
def upgrade():
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('fk_id', postgresql.UUID(), nullable=True),
    sa.Column('ident', sa.Unicode(), server_default='', nullable=False),
    ...
    sa.Column('leader_id', postgresql.UUID(), nullable=True),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('fk_id', postgresql.UUID(), nullable=False),
    sa.Column('model', sa.Unicode(), server_default='', nullable=False),
    sa.Column('when', sa.DateTime(), nullable=False),
    sa.Column('who', sa.Unicode(), server_default='', nullable=False),
    sa.Column('page', sa.Unicode(), server_default='', nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('watchlist_id', postgresql.UUID(), nullable=True),
    ...
    sa.UniqueConstraint('badge_num', deferrable='True', initially='DEFERRED', name=op.f('uq_attendee_badge_num'))
    )
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('picked_up_by_id', postgresql.UUID(), nullable=False),
    sa.Column('picked_up_for_id', postgresql.UUID(), nullable=False),
    ...
    sa.Column('generated', sa.DateTime(), server_default=sa.text("timezone('utc', current_timestamp)"), nullable=False),
    sa.Column('hashed', sa.Unicode(), server_default='', nullable=False),
