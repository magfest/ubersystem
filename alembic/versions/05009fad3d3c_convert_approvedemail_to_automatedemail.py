...
def upgrade():
    ...
    if is_sqlite:
        with op.batch_alter_table('automated_email', reflect_kwargs=sqlite_reflect_kwargs) as batch_op:
            ...
            batch_op.add_column(sa.Column('approved', sa.Boolean(), server_default='True', nullable=False))
            ...
            batch_op.add_column(sa.Column('post_con', sa.Boolean(), server_default='False', nullable=False))
            batch_op.add_column(sa.Column('allow_during_con', sa.Boolean(), server_default='False', nullable=False))
        ...
        op.add_column('automated_email', sa.Column('approved', sa.Boolean(), server_default='True', nullable=False))
        ...
        op.add_column('automated_email', sa.Column('post_con', sa.Boolean(), server_default='False', nullable=False))
        op.add_column('automated_email', sa.Column('allow_during_con', sa.Boolean(), server_default='False', nullable=False))
...
def downgrade():
    ...
    op.drop_column('automated_email', 'post_con')
    op.drop_column('automated_email', 'allow_during_con')
