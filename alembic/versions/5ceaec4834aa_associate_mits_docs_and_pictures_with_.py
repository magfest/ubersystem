...
def upgrade():
    with op.batch_alter_table("mits_document") as batch_op:
        batch_op.add_column(sa.Column('game_id', residue.UUID(), nullable=False))
        batch_op.drop_constraint('fk_mits_document_team_id_mits_team', type_='foreignkey')
        batch_op.create_foreign_key(op.f('fk_mits_document_game_id_mits_game'), 'mits_game', ['game_id'], ['id'])
        batch_op.drop_column('team_id')
    with op.batch_alter_table("mits_picture") as batch_op:
        batch_op.add_column(sa.Column('game_id', residue.UUID(), nullable=False))
        batch_op.drop_constraint('fk_mits_picture_team_id_mits_team', type_='foreignkey')
        batch_op.create_foreign_key(op.f('fk_mits_picture_game_id_mits_game'), 'mits_game', ['game_id'], ['id'])
        batch_op.drop_column('team_id')
