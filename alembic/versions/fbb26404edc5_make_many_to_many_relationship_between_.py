...
def upgrade():
    ...
    sa.Column('panel_applicant_id', residue.UUID(), nullable=False),
    sa.Column('panel_application_id', residue.UUID(), nullable=False),
    ...
    op.add_column('panel_application', sa.Column('submitter_id', residue.UUID(), nullable=True))
