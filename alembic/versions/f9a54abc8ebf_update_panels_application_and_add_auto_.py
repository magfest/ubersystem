...
def upgrade():
    op.add_column('panel_application', sa.Column('accepted', sa.DateTime(timezone=True), nullable=True))
    op.add_column('panel_application', sa.Column('confirmed', sa.DateTime(timezone=True), nullable=True))
