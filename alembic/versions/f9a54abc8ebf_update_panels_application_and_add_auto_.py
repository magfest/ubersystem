...
def upgrade():
    op.add_column('panel_application', sa.Column('accepted', residue.UTCDateTime(), nullable=True))
    op.add_column('panel_application', sa.Column('confirmed', residue.UTCDateTime(), nullable=True))
