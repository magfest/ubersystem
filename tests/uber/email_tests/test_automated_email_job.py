...
class TestSendAutomatedEmailsJob:
    ...
    def test_run_succeeds(self, amazon_send_email_mock, set_test_approved_idents, get_test_email_category):
        ...
        assert SendAutomatedEmailsJob.last_result[get_test_email_category.ident]['unsent_because_unapproved'] == 0

        assert not SendAutomatedEmailsJob.running
        assert SendAutomatedEmailsJob.completed
    ...
    def test_run_no_email_approval(self, amazon_send_email_mock, get_test_email_category):
        ...
        assert SendAutomatedEmailsJob.last_result[get_test_email_category.ident]['unsent_because_unapproved'] == 2
